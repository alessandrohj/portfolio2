    ...
    return (
       <div className='min-h-screen home-main flex place-content-center pl-1 pr-1'>
           ...
           <div className='relative flex flex-col sm:responsive items-center gap-4'>
               <h1 className='text-5xl lg:text-6xl text-center text-black font-bold leading-none lg:leading-snug self-center pt-5'>Hey there! <br/> I'm Alessandro.</h1>
               <h3 className='text-lg md:text-xl lg:text-2xl text-black text-center font-bold leading-none lg:leading-snug'><Typing /></h3>
           </div>
           </div>
       </div>
    )
